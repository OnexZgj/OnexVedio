...
public class BGAMeiTuanRefreshView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        mPullDownView = (ImageView) findViewById(cn.bingoogolapple.refreshlayout.R.id.iv_meituan_pull_down);
        mReleaseRefreshingView = (ImageView) findViewById(cn.bingoogolapple.refreshlayout.R.id.iv_meituan_release_refreshing);
    }
