...
public class ItemFollowAdapter extends BaseQuickAdapter<FollowBeans.ItemListBeanX.DataBeanX.ItemListBean,BaseViewHolder> {


    public ItemFollowAdapter( @Nullable List<FollowBeans.ItemListBeanX.DataBeanX.ItemListBean> data) {
